...
__all__ = ["KaistDetection", "KaistParser"]


class KaistDetection(Detection):
    """ Kaist image detection """

    def serialize(self):
        """ generate a Kaist detection string """

        raise NotImplementedError

    def deserialize(self, string, class_label_map):
        """ parse a kaist detection string """
...
class KaistParser(Parser):
    """
    This parser is designed to parse the text based kaist detections compatible/generated by Piotr Dollar's toolbox_
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            raise ValueError("Kaist detection format requires a 'class_label_map' kwarg")

    def serialize(self, detections):
        """ Serialize input detection to kaist detection strings """
